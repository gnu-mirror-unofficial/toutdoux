...
<!-- ********************************************************************** -->
  ...
  <xsl:param name="intl-realise-avec" select="'R&#233;alis&#233; avec '"/>
  <xsl:param name="intl-icones-du" select="'Ic&#244;nes du '"/>
  <xsl:param name="intl-avec-la-fameuse-inspiration-de" select="'avec la fameuse inspiration de '"/>
  <xsl:param name="intl-webmestre" select="'Webmestre'"/>
  <xsl:param name="intl-site-heberge-par" select="'Site h&#233;berg&#233; par '"/>
<!-- ********************************************************************** -->
